...
//	SDL_DestroyTexture(texture);
//}
// Hàm để render điểm số lên màn hình
...
Uint32 update(Uint32 interval, void* param)
{
	...
	// To draw score on the left corner
	//std::stringstream ss;
	//ss << score;
	//drawScore(renderer, font, ss.str());
...
int main(int argc, char* args[])
{
	...
	{
		SDL_Rect rect1 = { SCREEN_WIDTH + i*254, 0 , 50,  random(80, 240) }, rect2 = { SCREEN_WIDTH + i*254, rect1.h + 200, 50, SCREEN_HEIGHT - rect2.y};
